...
def export_csv():
    ...
    try:
        # Create sample CSV with current session data
        from io import StringIO
        output = StringIO()
        ...
        # Write sample data (in a real app, this would come from session or database)
        writer.writerow([
            1, 
            'Sample message for CSV export', 
            'Safe', 
            0.95, 
